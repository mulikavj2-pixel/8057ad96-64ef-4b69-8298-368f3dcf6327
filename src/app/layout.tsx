...
export const metadata: Metadata = {
  ...
  description: "Discover exceptional coffee crafted by expert baristas. Visit Brew Haven for specialty drinks, cozy atmosphere, and community vibes.",
  keywords: "coffee shop, specialty coffee, cafe, barista, latte, espresso",
  ...
  openGraph: {
    title: "Brew Haven - Premium Coffee Shop",
    description: "Your favorite local coffee destination with premium beans and expert craftsmanship.",
    siteName: "Brew Haven",
    type: "website"
  },
  robots: {
